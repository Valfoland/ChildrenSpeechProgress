...
namespace Levels
{
    ...
    {
        [Header("Список уровней")] public List<DataLevelObjectLevels> DataLevels;
    }

    [System.Serializable]
    public class DataLevelObjectSection
    {
        [Header("Список миссий")] public List<DataLevelObjectMissions> DataLevelsOfMission;
    }

    public class LevelCreator : MonoBehaviour
    {
        [Header("Список разделов")] [SerializeField]
        protected List<DataLevelObjectSection> dataLevelsOfSection;
        ...
        public void CreateLevel()
        {
            ...
            prefabLvl = Instantiate(
                dataLevelsOfSection[DataGame.IdSelectSection].DataLevelsOfMission[DataGame.IdSelectMission]
